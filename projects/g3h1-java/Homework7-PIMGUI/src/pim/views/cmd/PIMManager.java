...
////            objectOutputStream.writeObject(orm);
...
////                    case "TODO":
////                        this.orm.add(new PIMTodo(entityStr));
////                        count += 1;
////                        break;
////                    case "NOTE":
////                        this.orm.add(new PIMNote(entityStr));
////                        count += 1;
////                        break;
////                    case "APPO":
////                        this.orm.add(new PIMAppointment(entityStr));
////                        count += 1;
////                        break;
////                    case "CONT":
////                        this.orm.add(new PIMContact(entityStr));
////                        count += 1;
////                        break;
////                    default:
////                        System.out.printf("String '%s' did not match any entity.\n", entityStr);
