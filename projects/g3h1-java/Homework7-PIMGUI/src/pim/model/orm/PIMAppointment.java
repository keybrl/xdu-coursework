...
public class PIMAppointment extends PIMEntity {
    ...
    PIMAppointment(int id, User user, boolean shareable) {
        super(id, user, shareable);
        this.date = new Date();  // 当前时间
        this.desc = "Appointment with someone...";
    }
    public PIMAppointment(int id, User user, boolean shareable, String priority, Date date, String desc) {
    ...
    PIMAppointment(int id, User user, boolean shareable, String fmtStr) {
        super(id, user, shareable);
